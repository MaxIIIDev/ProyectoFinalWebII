...
HabitacionService.getHabitacionesDisponibles = async (genero, ala) => {
    try {
        const habitacionesCon1Habitacion = await Hospital_habitaciones_1.Hospital_habitaciones.findAll({
            include: [
                {
        ...
        const habitacionesConDosHabitaciones = await Hospital_habitaciones_1.Hospital_habitaciones.findAll({
            include: [
                {
                    model: Hospital_camas_1.Hospital_camas,
                    as: "camas",
...
//# sourceMappingURL=HabitacionService.js.map