...
export class EnfermeriaRoutes{
    ...
    static  enfermeriaRoutes(conexionBd:Conexion):Router{
        ...
        router.get("/view/historial/sintomas/paciente", middlewareEnfermero[0],middlewareEnfermero[2], controller.vistaAllSintomas)
        ...
        router.get("/view/tratamientos/prescritos/historial", middlewareEnfermero[0],middlewareEnfermero[2], controller.vistaHistorialTratamientosPrescritos)
