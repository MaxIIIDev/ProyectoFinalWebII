...
--
-- Servidor: localhost
-- Tiempo de generación: 04-07-2025 a las 23:29:23
...
(1, 'Baja', 1, 1, 1, '2023-05-18 09:00:00', '2025-06-26 02:31:38', 1, 2, NULL),
(2, 'Baja', 1, 4, 1, '2023-05-17 15:30:00', '2025-06-26 19:12:16', 2, 47, NULL),
(3, 'Activo', 3, 4, 1, '2023-05-18 10:15:00', NULL, 3, 5, NULL),
(4, 'Activo', 5, 1, 3, '2023-05-18 08:45:00', NULL, 4, 7, NULL),
(5, 'Alta', 4, 3, 1, '2023-05-16 14:00:00', '2023-05-18 09:30:00', 5, 9, NULL),
(6, 'Activo', 1, 1, 3, '2025-06-24 22:41:47', '2025-06-24 22:41:47', 6, 23, NULL),
...
(9, 'Baja', 1, 4, 1, '2025-06-26 02:21:34', '2025-06-26 19:12:16', 2, 47, NULL),
(10, 'Activo', 1, 4, 1, '2025-06-26 02:32:50', '2025-06-26 02:32:50', 1, 2, NULL),
(14, 'Activo', 1, 4, 1, '2025-06-26 23:17:39', '2025-06-26 23:17:39', 2, 8, NULL);
...
(2, 0, 1, '2025-05-18 04:56:34', '2025-06-26 02:32:50'),
...
(8, 0, 5, '2025-05-18 04:56:34', '2025-06-26 23:17:39'),
...
(46, 0, 29, '2025-05-18 04:56:34', '2025-06-26 23:09:06'),
(47, 0, 30, '2025-05-18 04:56:34', '2025-06-26 19:12:32'),
...
(7, 1, 'alergia a la penicilina\r\n', 3, NULL, '2025-07-01 21:14:50', '2025-07-01 21:14:50');
...
(9, 'Cancer de pulmon', 'Cancer cronico', 3, '2025-07-03 03:14:42', '2025-07-03 03:14:42', 1);
...
(1, '2020-05-15', 1, 'Apendicectomía por apendicitis aguda', 1, 1, '2025-05-18 04:56:45', '2025-05-18 04:56:45', NULL),
(3, '2022-11-10', 2, 'Colecistectomía laparoscópica', 1, 5, '2025-05-18 04:56:45', '2025-05-18 04:56:45', NULL);
...
INSERT INTO `paciente_diagnosticos` (`id_Paciente_Diagnosticos`, `fecha`, `id_tipo_de_diagnostico`, `detalles`, `id_medico`, `id_paciente`, `id_tratamiento`, `updatedAt`, `id_Admision`) VALUES
(1, '2023-05-18 10:00:00', 2, 'Apendicitis aguda resuelta con cirugía', 1, 1, 1, '2025-05-18 04:57:09', NULL),
(2, '2023-05-18 10:30:00', 1, 'Gastroenteritis aguda', 2, 2, 2, '2025-05-18 04:57:09', NULL),
(3, '2023-05-18 11:00:00', 2, 'Artrosis de rodilla derecha', 1, 3, 3, '2025-05-18 04:57:09', NULL),
(4, '2023-05-18 11:30:00', 1, 'Asma bronquial', 2, 4, 4, '2025-05-18 04:57:09', NULL),
(5, '2023-05-18 12:00:00', 2, 'Colecistitis crónica', 1, 5, 5, '2025-05-18 04:57:09', NULL);
...
(1, '2023-05-18', 75, 'Normal', 'Alert', '2025-05-18 04:57:09', NULL, NULL, NULL, 0, 0),
(2, '2023-05-18', 80, 'Pálido', 'Alert', '2025-05-18 04:57:09', NULL, NULL, NULL, 0, 0),
(3, '2023-05-18', 70, 'Normal', 'Alert', '2025-05-18 04:57:09', NULL, NULL, NULL, 0, 0),
(4, '2023-05-18', 78, 'Normal', 'Alert', '2025-05-18 04:57:09', NULL, NULL, NULL, 0, 0),
(5, '2023-05-18', 82, 'Normal', 'Alert', '2025-05-18 04:57:09', NULL, NULL, NULL, 0, 0),
(6, '2025-07-04', 120, 'marron', 'Excelente', '2025-07-04 00:57:05', 3, 3, 1, 120, 80),
(7, '2025-07-04', 120, 'marron', 'Excelente', '2025-07-04 01:02:47', 3, 3, 1, 120, 80),
(8, '2025-07-04', 120, 'marron', 'Excelente', '2025-07-04 01:04:59', 3, 3, 1, 120, 80);
...
(3, 1, 3, '2025-07-03 00:57:49', '2025-07-03 23:24:34', 3, 'dolor de cabeza'),
...
INSERT INTO `paciente_recetas` (`id_Receta`, `fecha`, `id_paciente`, `id_medico`, `id_medicamento`, `updatedAt`, `indicacion`) VALUES
(1, '2023-05-18 10:15:00', 1, 1, 1, '2025-05-18 05:00:59', NULL),
(2, '2023-05-18 10:45:00', 2, 2, 2, '2025-05-18 05:00:59', NULL),
(3, '2023-05-18 11:15:00', 3, 1, 3, '2025-05-18 05:00:59', NULL),
(4, '2023-05-18 11:45:00', 4, 2, 5, '2025-05-18 05:00:59', NULL),
(5, '2023-05-18 12:15:00', 5, 1, 4, '2025-05-18 05:00:59', NULL);
...
INSERT INTO `paciente_tratamientos` (`id_tratamiento`, `id_tipo_de_tratamiento`, `detalle`, `cantidad_suministrada`, `fecha_de_inicio`, `fecha_de_fin`, `id_paciente`, `id_medicamento`, `id_enfermero`, `updatedAt`, `id_medico`) VALUES
(1, 1, 'Ibuprofeno cada 8 horas por 5 días', 10, '2023-05-18 10:15:00', '2023-05-23 00:00:00', 1, 1, 1, '2025-05-18 04:57:30', NULL),
(2, 2, 'Amoxicilina inyectable cada 12 horas por 7 días', 7, '2023-05-18 10:45:00', '2023-05-25 00:00:00', 2, 2, 1, '2025-05-18 04:57:30', NULL),
(3, 1, 'Paracetamol cada 6 horas por dolor', 15, '2023-05-18 11:15:00', '2023-05-21 00:00:00', 3, 3, 2, '2025-05-18 04:57:30', NULL),
(4, 1, 'Loratadina diaria por alergia', 7, '2023-05-18 11:45:00', '2023-05-25 00:00:00', 4, 5, 2, '2025-05-18 04:57:30', NULL),
(5, 1, 'Diclofenac cada 12 horas por 3 días', 6, '2023-05-18 12:15:00', '2023-05-21 00:00:00', 5, 4, 1, '2025-05-18 04:57:30', NULL),
(11, 2, 'dddddddddddddddsaaaaa', 80, '2025-07-01 21:13:12', NULL, 3, 1, 1, '2025-07-01 21:13:12', NULL);
...
(2, 'medico1@gmail.com', '$2b$10$.FnLxKlLBuwP20gcvJJ7C.HeId02c25zhd8rEd2bRWQl30x99hury', 1, 0, 2, '2025-05-18 04:56:06', '2025-06-21 20:20:20'),
(3, 'medico2@gmail.com', '$2b$10$5HyZTasYa.H0PMY0GgC7kOwtO1XTyDcY0ph9pqpsq/m07aGqTIkr6', 1, 0, 2, '2025-05-18 04:56:06', '2025-05-18 04:56:06'),
(4, 'enfermero1@gmail.com', '$2a$10$xD7J2XW3q5U5e5v5e5v5eO5v5e5v5e5v5e5v5e5v5e5v5e5v5e5v5e', 1, 0, 3, '2025-05-18 04:56:06', '2025-05-18 04:56:06'),
...
--
ALTER TABLE `admisiones`
  MODIFY `id_Admision` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `paciente_antecedentes_familiares`
  MODIFY `id_Antecedente_Familiar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `paciente_evaluacion_fisica`
  MODIFY `id_Evaluacion_fisica` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `paciente_medicacion_actual`
--
ALTER TABLE `paciente_medicacion_actual`
  MODIFY `id_Paciente_Medicacion_Actual` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `admisiones`
  ADD CONSTRAINT `admisiones_ibfk_116` FOREIGN KEY (`id_motivo_de_Internacion`) REFERENCES `motivo_de_internacion` (`id_motivo_de_Internacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `admisiones_ibfk_117` FOREIGN KEY (`id_prioridad_de_atencion`) REFERENCES `prioridad_de_atencion` (`id_prioridad_de_atencion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `admisiones_ibfk_118` FOREIGN KEY (`id_tipo_de_admision`) REFERENCES `tipo_de_admision` (`id_tipo_de_admision`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `admisiones_ibfk_119` FOREIGN KEY (`id_Paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `admisiones_ibfk_120` FOREIGN KEY (`id_Cama`) REFERENCES `hospital_camas` (`id_Cama`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `medicos`
  ADD CONSTRAINT `medicos_ibfk_47` FOREIGN KEY (`id_Especialidad`) REFERENCES `especialidades` (`id_Especialidad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `medicos_ibfk_48` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_Usuario`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `pacientes`
--
ALTER TABLE `pacientes`
  ADD CONSTRAINT `pacientes_ibfk_47` FOREIGN KEY (`id_tipo_sanguineo`) REFERENCES `tipo_sanguineo` (`id_tipo_sanguineo`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `pacientes_ibfk_48` FOREIGN KEY (`id_seguro_medico`) REFERENCES `paciente_seguro_medico` (`id_seguro_medico`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_alergias`
--
ALTER TABLE `paciente_alergias`
  ADD CONSTRAINT `paciente_alergias_ibfk_70` FOREIGN KEY (`id_nombre_alergia`) REFERENCES `nombre_alergia` (`id_nombre_alergia`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_alergias_ibfk_71` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_alergias_ibfk_72` FOREIGN KEY (`id_tratamiento`) REFERENCES `paciente_tratamientos` (`id_tratamiento`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_antecedentes_familiares`
--
ALTER TABLE `paciente_antecedentes_familiares`
  ADD CONSTRAINT `paciente_antecedentes_familiares_ibfk_17` FOREIGN KEY (`id_Paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_antecedentes_familiares_ibfk_18` FOREIGN KEY (`id_Lazo_Familiar`) REFERENCES `lazo_familiar` (`id_Lazo_Familiar`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_cirugias`
--
ALTER TABLE `paciente_cirugias`
  ADD CONSTRAINT `paciente_cirugias_ibfk_82` FOREIGN KEY (`id_nombre_cirugia`) REFERENCES `nombre_cirugia` (`id_nombre_cirugia`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_cirugias_ibfk_83` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_Medico`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_cirugias_ibfk_84` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_cirugias_ibfk_85` FOREIGN KEY (`id_Admision`) REFERENCES `admisiones` (`id_Admision`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_diagnosticos`
--
ALTER TABLE `paciente_diagnosticos`
  ADD CONSTRAINT `paciente_diagnosticos_ibfk_105` FOREIGN KEY (`id_tipo_de_diagnostico`) REFERENCES `tipo_de_diagnostico` (`id_tipo_de_diagnostico`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_diagnosticos_ibfk_106` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_Medico`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_diagnosticos_ibfk_107` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_diagnosticos_ibfk_108` FOREIGN KEY (`id_tratamiento`) REFERENCES `paciente_tratamientos` (`id_tratamiento`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_diagnosticos_ibfk_109` FOREIGN KEY (`id_Admision`) REFERENCES `admisiones` (`id_Admision`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_evaluacion_fisica`
--
ALTER TABLE `paciente_evaluacion_fisica`
  ADD CONSTRAINT `paciente_evaluacion_fisica_ibfk_28` FOREIGN KEY (`id_Admision`) REFERENCES `admisiones` (`id_Admision`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_evaluacion_fisica_ibfk_29` FOREIGN KEY (`id_Paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_evaluacion_fisica_ibfk_30` FOREIGN KEY (`id_Enfermero`) REFERENCES `enfermeros` (`id_Enfermero`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_medicacion_actual`
--
ALTER TABLE `paciente_medicacion_actual`
  ADD CONSTRAINT `paciente_medicacion_actual_ibfk_43` FOREIGN KEY (`id_Medicamento`) REFERENCES `medicamentos` (`id_Medicamento`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_medicacion_actual_ibfk_44` FOREIGN KEY (`id_Admision`) REFERENCES `admisiones` (`id_Admision`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_medicacion_actual_ibfk_45` FOREIGN KEY (`id_Paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_pruebas_diagnosticas`
--
ALTER TABLE `paciente_pruebas_diagnosticas`
  ADD CONSTRAINT `paciente_pruebas_diagnosticas_ibfk_70` FOREIGN KEY (`id_nombre_prueba_diagnostica`) REFERENCES `nombre_prueba_diagnostica` (`id_nombre_prueba_diagnostica`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_pruebas_diagnosticas_ibfk_71` FOREIGN KEY (`id_diagnostico`) REFERENCES `paciente_diagnosticos` (`id_Paciente_Diagnosticos`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_pruebas_diagnosticas_ibfk_72` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_recetas`
--
ALTER TABLE `paciente_recetas`
  ADD CONSTRAINT `paciente_recetas_ibfk_70` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_recetas_ibfk_71` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_Medico`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_recetas_ibfk_72` FOREIGN KEY (`id_medicamento`) REFERENCES `medicamentos` (`id_Medicamento`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_seguro_medico`
--
ALTER TABLE `paciente_seguro_medico`
  ADD CONSTRAINT `paciente_seguro_medico_ibfk_47` FOREIGN KEY (`id_mutual`) REFERENCES `mutuales` (`id_mutual`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_seguro_medico_ibfk_48` FOREIGN KEY (`id_categoria_seguro`) REFERENCES `categoriasseguros` (`id_Categoria_Seguro`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `paciente_tratamientos`
--
ALTER TABLE `paciente_tratamientos`
  ADD CONSTRAINT `paciente_tratamientos_ibfk_102` FOREIGN KEY (`id_tipo_de_tratamiento`) REFERENCES `tipo_de_tratamiento` (`id_Tipo_De_Tratamiento`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_tratamientos_ibfk_103` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_tratamientos_ibfk_104` FOREIGN KEY (`id_medicamento`) REFERENCES `medicamentos` (`id_Medicamento`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_tratamientos_ibfk_105` FOREIGN KEY (`id_enfermero`) REFERENCES `enfermeros` (`id_Enfermero`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `paciente_tratamientos_ibfk_106` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_Medico`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `sintomas`
  ADD CONSTRAINT `sintomas_ibfk_47` FOREIGN KEY (`id_Admision`) REFERENCES `admisiones` (`id_Admision`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `sintomas_ibfk_48` FOREIGN KEY (`id_Paciente_Diagnosticos`) REFERENCES `paciente_diagnosticos` (`id_Paciente_Diagnosticos`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `turnos`
--
ALTER TABLE `turnos`
  ADD CONSTRAINT `turnos_ibfk_61` FOREIGN KEY (`id_horario_turno`) REFERENCES `horarios_turnos` (`id_horario_turno`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `turnos_ibfk_62` FOREIGN KEY (`id_paciente`) REFERENCES `pacientes` (`id_Paciente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `turnos_ibfk_63` FOREIGN KEY (`id_medico`) REFERENCES `medicos` (`id_Medico`) ON DELETE CASCADE ON UPDATE CASCADE;
